...
sudo -E duplicity --archive-dir="$archive_dir" remove-all-but-n-full 3 --force "$destination/home"
...
sudo -E duplicity --archive-dir="$archive_dir" remove-all-but-n-full 3 --force "$destination/etc"
...
sudo -E duplicity --archive-dir="$archive_dir" remove-all-but-n-full 3 --force "$destination/root"
...
if [[ $HOSTNAME == srv ]]; then
    ...
    sudo -E duplicity --archive-dir="$archive_dir" remove-all-but-n-full 3 --force "$destination/srv"
    ...
    sudo -E duplicity --archive-dir="$archive_dir" remove-all-but-n-full 3 --force "$destination/cron"
fi
