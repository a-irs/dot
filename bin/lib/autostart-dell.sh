...
#LC_ALL=C xrandr -q | grep 'HDMI1 connected' && xrandr --output LVDS1 --off --output HDMI1 --auto
#LC_ALL=C xrandr -q | grep 'HDMI2 connected' && xrandr --output LVDS1 --off --output HDMI2 --auto
