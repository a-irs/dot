...
let g:markdown_fenced_languages = ['html', 'python', 'bash=sh', 'sh', 'shell=sh', 'ini=dosini', 'ocaml', 'rust', 'css', 'erb=eruby', 'ruby', 'c', 'cpp', 'dockerfile', 'js=javascript', 'yaml', 'jinja2', 'sql', 'ps1', 'config', 'asm', 'json', 'patch=diff', 'diff', 'go', 'nim', 'log']
