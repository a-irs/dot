return {
    {
        ...
        config = function()
            vim.cmd [[
                ...
                let g:ansible_template_syntaxes = { '*.conf.j2': 'conf', '*.rules.j2': 'iptables', '*.xml.j2': 'xml', '*.sh.j2': 'sh', '*.yml.j2': 'yaml.ansible', '*.py.j2': 'python', '*.jcfg.j2': 'conf', '*.rb.j2': 'ruby', '*iptables/*': 'iptables', '*.json.j2': 'json' }
